...
public:
    ...
    {
        return m_hightlightIntensity;
    }
    void setHighlightIntensity(float inI)
    {
        m_hightlightIntensity = inI;
    }
    void setMinTime(uint64_t _minTime);
    void setMaxTime(uint64_t _maxTime);
    void setMinMaxTime(uint64_t _minTime, uint64_t _maxTime);
    uint64_t getMarkerFromTime() const
    {
        return m_markerSelectFromTime;
    }
    uint64_t getMarkerToTime() const
    {
        return m_markerSelectToTime;
    }
    ...
    uint64_t getHighlightTime() const
    {
        return m_hightlightTime;
    }
    uint64_t getHighlightTimeEnd() const
    {
        return m_hightlightTimeEnd;
    }
