...
public:
    ...
    rtm::StackTrace** getSavedStackTraces()
    {
        return m_savedStackTraces;
    }
    uint32_t getSavedStackTracesCount()
    {
        return m_savedStackTracesCount;
    }

    void changeEvent(QEvent* _event);
    void setHistogramType(int _type)
    {
        m_histogramType = _type;
    }
    void setHistogramMode(int _mode)
    {
        m_histogramMode = _mode;
    }
    void setHistogramPeaks(bool _peaks)
    {
        m_histogramPeaks = _peaks;
    }
    void setHistogramScale(bool _scale)
    {
        m_histogramPeaks = _scale;
    }
    ...
    bool getHistogramPeaks() const
    {
        return m_histogramPeaks;
    }
    bool getHistogramScale() const
    {
        return m_histogramScale;
    }
    uint64_t getMinTime()
    {
        return m_minTime;
    ...
    uint64_t getCurrentHeap()
    {
        return m_currentHeap;
    }
    void setCurrentHeap(uint64_t inHeap)
    {
        m_currentHeap = inHeap;
    }
    rdebug::ModuleInfo* getCurrentModule()
    {
