    ...
    : QWidget(_parent, _flags)
{
    ...
    connect(m_groupList,
            ...
            this,
            SIGNAL(setStackTrace(rtm::StackTrace**, int)));
    connect(m_operationList,
            SIGNAL(setStackTrace(rtm::StackTrace**, int)),
            this,
            SIGNAL(setStackTrace(rtm::StackTrace**, int)));
    connect(m_operationListInvalid,
            SIGNAL(setStackTrace(rtm::StackTrace**, int)),
            this,
            SIGNAL(setStackTrace(rtm::StackTrace**, int)));
    connect(m_treeMap,
    ...
    connect(m_groupList,
            SIGNAL(peakUsageSortingDone(GroupMapping*)),
            m_hotspots,
            SLOT(peakUsageSortingDone(GroupMapping*)));
    connect(m_groupList,
            SIGNAL(peakCountSortingDone(GroupMapping*)),
            m_hotspots,
            SLOT(peakCountSortingDone(GroupMapping*)));
