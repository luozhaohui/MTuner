...
public:
    ...
    void setItem(TreeMapGraphicsItem* _item)
    {
        m_item = _item;
    }
    ...
    inline TreeMapNode* getHighlightNode()
    {
        return m_highlightNode;
    }
    inline TreeMapNode* getClickedNode()
    {
        return m_clickedNode;
    }
    std::vector<TreeMapNode>& getTree()
    {
        return m_tree;
    }
    QVector<QLineF>& getTreeLines()
    {
        return m_treeLines;
    }
