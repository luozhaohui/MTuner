...
void HistogramWidget::displayTypeChanged(int _index)
{
    ...
    {
        case 0:
            h->setHistogramType(HistogramType::Size);
            break;
        case 1:
            h->setHistogramType(HistogramType::Overhead);
            break;
        case 2:
            h->setHistogramType(HistogramType::Count);
            break;
    };
    if (m_binView)
...
void HistogramWidget::displayModeChanged(int _index)
{
    ...
    {
        case 0:
            h->setDisplayMode(DisplayMode::Global);
            break;
        case 1:
            h->setDisplayMode(DisplayMode::Snapshot);
            break;
        case 2:
            h->setDisplayMode(DisplayMode::Both);
            break;
    };
    if (m_binView)
